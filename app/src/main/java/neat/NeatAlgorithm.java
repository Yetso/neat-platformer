...
public class NeatAlgorithm {
    ...
    // private final boolean use_species = Config.getBool("use_species");
    // private final int maxGenerationsWithSpecies = Config.getInt("max_generations_with_species");
    // private double speciesDeltaThreshold = Config.getDouble("species_delta_threshold");
    // private double speciesStaleThreshold = Config.getInt("species_stale_threshold");
    // private final boolean elitism = Config.getBool("elitism");
